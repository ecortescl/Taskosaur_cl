...
export default function SprintPlanning({ projectId, sprintId }: SprintPlanningProps) {
  ...
  const renderTask = (task: Task, inSprint: boolean) => (
    <Card
      key={task.id}
      className={`sprints-planning-task-card ${draggedTask?.id === task.id ? "sprints-planning-task-card-dragging" : ""
    ...
    return (
      <div className="sprints-empty-state">
        ...
        <p className="sprints-empty-description">
          Por favor, seleccione un sprint del menú desplegable superior para comenzar la planificación.
        </p>
      </div>
    );
  }
    ...
    <div className="sprints-planning-container">
      ...
      <div className="sprints-planning-header">
        <div>
          ...
          <p className="sprints-planning-subtitle">{currentSprint?.name || "Seleccione un sprint"}</p>
        </div>
          ...
          <div className="sprints-planning-info-grid">
            <div>
              ...
              <p className="sprints-planning-info-section-text">
                {currentSprint?.goal || "Sin objetivo definido"}
              </p>
            </div>
            <div>
              <h3 className="sprints-planning-info-section-title">
            ...
            <div>
              ...
              <p className="sprints-planning-info-section-text">
                {(currentSprint as any)?.capacity || 0} horas
              </p>
            </div>
          </div>
        </CardContent>
          ...
          <CardHeader className="sprints-planning-column-header">
            <div className="sprints-planning-column-title-row">
              ...
              <div className="sprints-planning-column-meta">
                <span>{backlogTasks.length} tareas</span>
                <span>{getTotalStoryPoints(backlogTasks)} PH</span>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            ...
            >
              ...
              {backlogTasks.length === 0 && (
                <div className="sprints-planning-empty">
                  ...
                  <p className="sprints-planning-empty-text">No hay tareas en el backlog</p>
                </div>
              )}
            </div>
          </CardContent>
        ...
        <Card className="sprints-planning-column-card">
          <CardHeader className="sprints-planning-column-header">
            <div className="sprints-planning-column-title-row">
              ...
              <div className="sprints-planning-column-meta">
                <span>{sprintTasks.length} tareas</span>
                <span>{getTotalStoryPoints(sprintTasks)} PH</span>
              </div>
            </div>
          </CardHeader>
          <CardContent>
              ...
              {sprintTasks.length === 0 && (
                <div className="sprints-planning-empty">
                  ...
                  <p className="sprints-planning-sprint-empty-title">
                    Arrastre tareas aquí para añadirlas al sprint
                  </p>
                  <p className="sprints-planning-sprint-empty-subtitle">
                    Haga clic en las tareas para moverlas entre el backlog y el sprint
                  </p>
                </div>
              )}
            </div>
        ...
        <CardContent>
          <div className="sprints-planning-summary-grid">
            <div className="sprints-planning-summary-stat">
              ...
              <div className="sprints-planning-summary-stat-label">Tareas</div>
            </div>
            <div className="sprints-planning-summary-stat">
              ...
              <div className="sprints-planning-summary-stat-label">Puntos de Historia</div>
            </div>
            <div className="sprints-planning-summary-stat">
              ...
              <div className="sprints-planning-summary-stat-label">Tiempo Estimado</div>
            </div>
            <div className="sprints-planning-summary-stat">
              ...
              <div className="sprints-planning-summary-stat-label">Capacidad</div>
            </div>
          </div>
        </CardContent>
      </Card>
